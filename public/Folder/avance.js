        ...
        if (especificar === 1) {
            ...
            if (checkedItems_etapa) {
                var row = {Canti: $("#cant").val(), varCodiElemento: $("#id_codigo").val(), nombre: $("#nombre").val(),
                    ...
                    Obs1: $("#Obs1").val(), obs2: $("#obs2").val(), obs3: $("#obs3").val(), obs4: $("#obs4").val()
                };
...
$("#asignar_avance").on('click', function () {
    ...
    for (var i = 0; i < rowindex.length; i++) {
        ...
        var row = {Canti: textData['Canti'], varCodiElemento: textData['varCodiElemento'], nombre: textData['nombre'],
            ...
            tipo_reporte: 1, DocEnvioTS: textData['DocEnvioTS'], bulto: textData['var_bulto'], Obs1: textData['Obs1'], obs2: textData['obs2'], obs3: textData['obs3'], obs4: textData['obs4']
        };
