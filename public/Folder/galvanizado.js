                    ...
                    $("#grid_galv").jqxGrid({
                        ...
                        columns: [
                            ...
                            {text: 'ZINC(%)_fake', width: '10%', datafield: 'varPorcZinc',cellformat:"c3",hidden:true, aggregates: [{
                             ...
                             {text: 'ZINC(%)', width: '10%', datafield: 'porcentajezinc',aggregates: [{

                                        '<b>#</b>':
                                                function (aggregatedValue, currentValue, column, record) {

                                                    var total = 0;
                                                    total = parseFloat(record['porcentajezinc']) + parseFloat(aggregatedValue);
                                                    total = parseFloat(total).toFixed(3);
                                                    return total;
                                                }
                                    }]},
                            ...
                            {text: 'ZINC(%)_fake', width: '10%', datafield: 'varPorcZinc',format:"d3",hidden:true, aggregates: [{
                                        ...
                                        '<b>#</b>':
                                                function (aggregatedValue, currentValue, column, record) {
                                                    ...
                                                    var total = 0;
                                                    total = parseFloat(record['varPorcZinc']).toFixed(3) + parseFloat(aggregatedValue);
                                                    total = parseFloat(total).toFixed(3);
                                                    console.log(total);
                                                    return total;
                                                }
        ...
        success: function (responses) {
            ...
            $("#grid_deta_galv").jqxGrid({
                ...
                columns: [
                    ...
                    {text: 'Zinc (%)', width: '10%', datafield: 'varPorcZinc', aggregates: [{
