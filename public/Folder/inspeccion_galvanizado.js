          ...
          dato_exportar= JSON.stringify(responses.data);
                ...
                if(check2==="1"){
                            ...
                            $("#grid_insp_galv").jqxGrid({
                              ...
                              columns: [
                                  ...
                                  {text: 'Zinc(%)', datafield: 'varPorcZinc',width:'10%', cellsalign: 'left',aggregates: [{
                                            '<b>#</b>':
                                                    function (aggregatedValue, currentValue, column, record) {

                                                        var total = 0;
                                                        total = parseFloat(record['varPorcZinc']) + parseFloat(aggregatedValue);
                                                        total = parseFloat(total).toFixed(3);
                                                        return total;
                                                    },
                                        }]},
            ...
            $("#grid_insp_galv").jqxGrid({
                    ...
                    columns: [
                        ...
                        {text: 'Elemento', datafield: 'varDescTipoProd',width:'10%', cellsalign: 'left'},
                        {text: 'Tipo Galvanizado', datafield: 'varTipoGalv',width:'10%', cellsalign: 'left'},
                        {text: 'idGanchera', datafield: 'intGanchera',width:'10%', cellsalign: 'left',hidden:true},
                        {text: 'Turno', datafield: 'varTurno',width:'10%', cellsalign: 'left'},
                        {text: 'Hora Entrada', datafield: 'varHoraEntr',width:'10%', cellsalign: 'left'},
                        {text: 'Hora Salida', datafield: 'varHoraSali',width:'10%', cellsalign: 'left'},
                        {text: 'Cantidad', datafield: 'intCantidad',width:'10%', cellsalign: 'left',aggregates: [{
                                            '<b>#</b>':
                                                    function (aggregatedValue, currentValue, column, record) {
                        ...
                        {text: 'Fecha Interno', datafield: 'dateFechIntern',width:'10%', cellsalign: 'left'},
                        {text: 'Numero Guia', datafield: 'varNumeGuia',width:'10%', cellsalign: 'left'},
                         {text: 'Cant. Total', datafield: 'intCantTota',width:'10%', cellsalign: 'left',aggregates: [{
                                            '<b>#</b>':
                                                    function (aggregatedValue, currentValue, column, record) {
                         ...
                         {text: 'Cant. Registro', datafield: 'intCantRegi',width:'10%', cellsalign: 'left',aggregates: [{
                                            '<b>#</b>':
                                                    function (aggregatedValue, currentValue, column, record) {
                         ...
                         {text: 'Peso Ingreso', datafield: 'deciPesoInge',width:'10%', cellsalign: 'left',aggregates: [{
                                            '<b>#</b>':
                                                    function (aggregatedValue, currentValue, column, record) {
                         ...
                         {text: 'Peso Bruto', datafield: 'deciPesoBruto',width:'10%', cellsalign: 'left'},
                         
                         {text: 'Hijo', datafield: 'intEsHijo',width:'10%', cellsalign: 'left',hidden:true},
                         {text: 'Id_InspGalv', datafield: 'intIdInspGalv',width:'10%', cellsalign: 'left',hidden:true},
...
function combo_opcion(){
     var tipo_opcion = [{'value': '1', 'label': 'CONTROL DE MICRAJE'}, {'value': '2', 'label': 'OBSERVACION'}];
...
function desca_archi(idgalv){
    ...
    consu_zinc = dataRecord.deciConsumoZinc;
     ...
     //(orden_servi,idproy,codiproy,tipoorden,turno,fecha_inicio,hora_entr,razon,num_guia,cantidad,tipo_mate,
     //peso_negro,peso_galvanizado,consu_zinc,porce_zinc);
      combo_opcion();
    $("#modal-pregunta-opcion").modal('show');
    /*if(dataRecord.varOrdenServi===null){
        //hidde_grid
        //OBSERVACION
        $("#mostrar_ot").removeClass('hidde_grid');
        $("#mostrar_os").addClass('hidde_grid');
        $("#ot_os_obsev_value").val(dataRecord.intIdProy);
        $("#ot_os_obsev").val(dataRecord.varCodiProy);
        
        //CONTROL DE METRAJE
        $("#mostrar_ot_contr_metr").removeClass('hidde_grid');
        $("#mostrar_os_contr_metr").addClass('hidde_grid');
        $("#ot_os_cont_metr_value").val(dataRecord.intIdProy);
        $("#ot_os_cont_metr").val(dataRecord.varCodiProy);
    }else{ 
        //OBSERVACION
        $("#mostrar_os").removeClass('hidde_grid');
        $("#mostrar_ot").addClass('hidde_grid'); 
        $("#ot_os_cont_metr_value").val(dataRecord.varOrdenServi);
        $("#ot_os_cont_metr").val(dataRecord.varCodiProy);
        //CONTROL DE METRAJE
        $("#mostrar_ot_contr_metr").removeClass('hidde_grid');
        $("#mostrar_os_contr_metr").addClass('hidde_grid'); 
    ...
    if(opciones==="1"){
        ...
        combo_especificacion();
         $("#tipo_orde_cont_metro").val(dataRecord.varTipoOrden);
         $("#turn_cont_metro").val(dataRecord.varTurno);
         $("#fech_cont_metro").val(dataRecord.dateFechInic);
         $("#hora_cont_metro").val(dataRecord.varHoraEntr);
         $("#cli_cont_metro").val(dataRecord.varRazoSoci);
         $("#guia_cont_metro").val(dataRecord.varNumeGuia);
         $("#canti_cont_metro").val(dataRecord.intCantidad);
         $("#tipo_mate_cont_metro").val(dataRecord.varTipoMate);
         $("#mate_cont_metro").val('');//material
         $("#peso_negr_cont_metro").val(dataRecord.deciPesoNegro);
         $("#peso_galv_cont_metro").val(dataRecord.deciPesoGalv);
         $("#consu_cont_metro").val(dataRecord.deciConsumoZinc);
         $("#zinc_cont_metro").val(dataRecord.varPorcZinc+"%");
        ...
        causa();
        combo_defecto();
        $("#clie_obser").val(dataRecord.varRazoSoci);
        $("#guia_obser").val(dataRecord.varNumeGuia);
        $("#num_ganch").val(dataRecord.intGanchera);
        $("#tipo_mate_insp_obse").val(dataRecord.varTipoMate);
        $("#canti_insp_obse").val(dataRecord.intCantidad);
...
$("#a1_1_cont_metr").on('change', function (event) {
    al_1_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            al_1_value = parseFloat(label);
               
    }
       
        promedio=(  parseFloat(al_1_value) + parseFloat(al_2_value)+ parseFloat(a2_1_value)+parseFloat(a2_2_value)+parseFloat(a3_1_value) + parseFloat(a3_2_value)+ parseFloat(a4_1_value)+ parseFloat(a4_2_value)+parseFloat(a5_1_value)+parseFloat(a5_2_value))/10;
        tolerancia=parseFloat((promedio/esp_max_cont_metr_value)*100);
       
        total_max_total=(consumo_zinc*esp_max_cont_metr_value)/promedio;
         exceso=total_max_total-consumo_zinc;
       
        if(exceso<0){
             $("#exce_cont_metr").val(exceso.toFixed(3)*-1);
        }else{
            $("#exce_cont_metr").val(exceso.toFixed(3));
        }
        $("#esp_max_total_cont_metr").val(total_max_total.toFixed(3));
        $("#tole_cont_metr").val(tolerancia.toFixed(3));
        $("#prome_cont_metr").val(promedio.toFixed(3));
    
});
$("#a1_2_cont_metr").on('change', function (event) {
    al_2_value =0;
    
     if (event.target) {
        var label = event.target.value;
            al_2_value = parseFloat(label);
...
$("#a2_1_cont_metr").on('change', function (event) {
    a2_1_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            a2_1_value = parseFloat(label);
...
$("#a2_2_cont_metr").on('change', function (event) {
    a2_2_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            a2_2_value = parseFloat(label);
                //console.log(a2_2_value);
    }
...
$("#a3_1_cont_metr").on('change', function (event) {
    a3_1_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            a3_1_value = parseFloat(label);
...
$("#a3_2_cont_metr").on('change', function (event) {
    a3_2_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            a3_2_value = parseFloat(label);
                //console.log(a3_2_value);
    }
...
$("#a4_1_cont_metr").on('change', function (event) {
    a4_1_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            a4_1_value = parseFloat(label);
                //console.log(a4_1_value.toFixed(3));
    }
...
$("#a4_2_cont_metr").on('change', function (event) {
    a4_2_value =0;
     promedio=0;
     if (event.target) {
        var label = event.target.value;
            a4_2_value = parseFloat(label);
...
$("#a5_1_cont_metr").on('change', function (event) {
    a5_1_value =0;
    promedio=0;
     if (event.target) {
        var label = event.target.value;
            a5_1_value = parseFloat(label);
               // console.log(a5_1_value);
    }
...
$("#a5_2_cont_metr").on('change', function (event) {
    a5_2_value =0;
    promedio=0;
     if (event.target) {
        var label = event.target.value;
            a5_2_value = parseFloat(label);
               // console.log(a5_2_value);            
    }
                                           ...
                                           if(valor4_2===""|| valor4_2==="0"){
                                              ...
                                              if(valor5_1===""|| valor5_1==="0"){
                                                  ...
                                                  if(valor5_2==="" || valor5_2==="0"){
                                                     ...
                                                     guardar_micraje(iddetagalv,especificacion,valor1_1,valor1_2,valor2_1,valor2_2,valor3_1,valor3_2,valor4_1,valor4_2,valor5_1,valor5_2,promedio,peso_max_total,tipo_mate,idresponsable,tole,pes_max,canti,pesonegro,peso_galvanizado,consum,zinc_por,id_insp_galv,hijo,material);
...
//function para micraje 
 function guardar_micraje(iddetagalv2,especificacion2,valor1_12,valor1_22,valor2_12,valor2_22,valor3_12,valor3_22,valor4_12,valor4_22,valor5_12,valor5_22,promedio2,peso_max_total2,tipo_mate2,idresponsable2,tole2,pes_max2,canti2,pesonegro2,peso_galvanizado2,consum2,zinc_por2,id_insp_galv2,hijo2,material2){
     let user= obtener_user();
     $.ajax({
        type: 'POST',
